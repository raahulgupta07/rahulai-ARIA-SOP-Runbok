<script lang="ts">
  ...
  const tabs: Tab[] = [
    ...
    { href: '/settings/access',      label: 'Access',          group: 'Workspace',    desc: 'Sectors, user roles and groups — the multi-tenant access model.', admin: true, d: 'M3 7V5a2 2 0 0 1 2-2h2M17 3h2a2 2 0 0 1 2 2v2M21 17v2a2 2 0 0 1-2 2h-2M7 21H5a2 2 0 0 1-2-2v-2M12 8a3 3 0 1 0 0 6 3 3 0 0 0 0-6z' },
    ...
    { href: '/settings/behaviour',   label: 'Answer Behaviour', group: 'Workspace',   desc: 'Per-project toggles — show or hide inline source citations.', admin: true, d: 'M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z' },
    { href: '/settings/persona',     label: 'Persona',         group: 'Workspace',    desc: "The agent's identity and voice, generated from your documents.", admin: true, d: 'M12 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM4 21v-1a6 6 0 0 1 6-6h4a6 6 0 0 1 6 6v1' },
    { href: '/settings/branding',    label: 'Branding',        group: 'Workspace',    desc: 'White-label the workspace — upload one logo and we generate the rest.', admin: true, d: 'M12 2a10 10 0 1 0 0 20 2 2 0 0 0 0-4h-1.5a1.5 1.5 0 0 1 0-3H17a3 3 0 0 0 3-3 7 7 0 0 0-8-7zM7.5 10.5h.01M10.5 7.5h.01M14 7h.01M16.5 10h.01' },
    ...
    { href: '/settings/microsoft',   label: 'Microsoft 365',   group: 'Integrations', desc: 'Connect SharePoint & OneDrive to import documents (app-only).', admin: true, d: 'M3 3h8v8H3zM13 3h8v8h-8zM3 13h8v8H3zM13 13h8v8h-8z' },
    { href: '/settings/sharepoint',  label: 'SharePoint Sync',  group: 'Integrations', desc: 'One SharePoint source, three ways: Desktop Sync, device login, or Azure app.', admin: true, d: 'M4 7c0 1.66 3.58 3 8 3s8-1.34 8-3-3.58-3-8-3-8 1.34-8 3zM4 7v10c0 1.66 3.58 3 8 3s8-1.34 8-3V7M12 13v7' },
...
<div class="h-full flex" style="background:var(--cream)">
  ...
  <!-- content -->
  <div class="flex-1 min-h-0 overflow-y-auto settings-area">
    <div class="px-7 pt-6 pb-1 settings-content-pad">
...
<style>
  ...
  @media (max-width: 640px) {
    :global(.settings-area table) { display: block; overflow-x: auto; white-space: nowrap; }
  }
</style>
